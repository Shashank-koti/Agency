...
export default function Footer() {
  const socials = [
    {
      name: "Instagram",
      icon: <InstagramIcon sx={{ mr: 0.5 }} />,
      url: "https://www.instagram.com/shashichowdary_5/",
    },
    {
      name: "LinkedIn",
      icon: <LinkedInIcon sx={{ mr: 0.5 }} />,
      url: "https://linkedin.com",
    },
    {
      name: "Twitter",
      icon: <TwitterIcon sx={{ mr: 0.5 }} />,
        ...
        >
          ...
          <Box flex={1} minWidth={260} maxWidth={360}>
            ...
            <Typography variant="body1" paragraph>
              Expert Web Development Solutions to Build Fast, Scalable, and
          ...
          >
            ...
            <Box>
              ...
              {["Home", "About Us", "Services", "Contact Us", "404 Page"].map(
                (text) => (
                  <Typography key={text} variant="body2" sx={{ mt: 1 }}>
